                ...
                <div className="flex flex-col justify-between">
                    ...
                    <div className="mt-6 flex gap-4 justify-center" style={{marginBottom: "20px"}}>
                        <button
                            ...
                            className="w-1/2 px-4 py-3 bg-red-700 text-white rounded-lg hover:bg-red-600 transition"
                        >
                            Quit Lobby
                        </button>
                        <button
                            onClick={handleStartGame}
                            className={`w-1/2 px-4 py-3 bg-green-500 text-white rounded-lg transition ${
